...
public class StockApi {
	...
	public static enum MARKET {
		MARKET_ETHCNY("ETHCNY"), MARKET_ETHBTC("ETHBTC"), MARKET_BTCCNY("BTCCNY");
	...
	public static enum ORDER_TYPE {
		ORDER_TYPE_SELL("sell"), ORDER_TYPE_BUY("buy");
	...
	private String doRequest(String url, Map<String, String> paramMap, HTTP_METHOD method)
